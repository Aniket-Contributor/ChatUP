...
import static com.example.chatup.chatscreen.reciverIImg;
import static com.example.chatup.chatscreen.senderImg;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                new AlertDialog.Builder(context).setTitle("Delete").setMessage("Are you sure to delete").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
